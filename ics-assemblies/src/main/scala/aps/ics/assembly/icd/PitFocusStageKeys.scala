...
object PitFocusStageKeys {
  val subsystem = "APS"

  /** API for Assembly: APS.ICS.PIT.FocusStage */
  object `ICS.PIT.FocusStage` {
    val prefix: Prefix = Prefix(Subsystem.APS, "ICS.PIT.FocusStage")

    /** PIT FocusStage status event */
    object StatusEvent {
