...
object PshFocusStageKeys {
  val subsystem = "APS"

  /** API for Assembly: APS.ICS.PSH.FocusStage */
  object `ICS.PSH.FocusStage` {
    val prefix: Prefix = Prefix(Subsystem.APS, "ICS.PSH.FocusStage")

    /** PSH FocusStage status event */
    object StatusEvent {
