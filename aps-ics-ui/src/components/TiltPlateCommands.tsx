/*
 * TiltPlate Commands section (SDD §4.3 "Command Section"). Commands grouped by
 * context (command kit): Setup, Motion (the position command + its Stop) and
    ...
    <Space direction='vertical' size={8} style={{ width: '100%' }}>
      ...
      <CommandGroups>
        ...
        <CommandGroup title='Motion'>
          <ParamCommand
            name='Position tilt plate (pupil x, y)'
