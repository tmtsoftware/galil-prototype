/*
 * PSH Detector Status section (SDD §5.3.3). Pure display of published telemetry.
 *
 * Like APT, but the PSH assembly has NO guidingStatus event: its configuration
...
import type { ConfigSnapshot, SetupSnapshot, StatusSnapshot, TemperatureSnapshot } from '../models/pshDetector'

const dash = (v: unknown): string => (v === undefined || v === null ? '—' : String(v))

export const PshDetectorStatus = ({
  status,
  temperature,
  setup,
  config,
