/*
 * PitFocusStage Status section (SDD §4.3). Pure display of the assembly's
...
import { PITFS_HCD_LABEL } from '../models/pitFocusStage'
import type { AxisSnapshot, StatusSnapshot } from '../models/pitFocusStage'
import type { SupervisorLifecycleState } from '@tmtsoftware/esw-ts'

export const PitFocusStageStatus = ({
  status,
  axis,
  lifecycle
}: {
  ...
  <Space direction='vertical' size={10} style={{ width: '100%' }}>
    ...
    <MetaFooter
      items={[
        { label: 'HCD', value: <>{PITFS_HCD_LABEL} <Typography.Text type='secondary' style={{ fontSize: 11 }}>(config)</Typography.Text></> },
