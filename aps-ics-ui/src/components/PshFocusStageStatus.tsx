/*
 * PshFocusStage Status section (SDD §4.3). Pure display of the assembly's
...
import { PSHFS_HCD_LABEL } from '../models/pshFocusStage'
import type { AxisSnapshot, StatusSnapshot } from '../models/pshFocusStage'
import type { SupervisorLifecycleState } from '@tmtsoftware/esw-ts'

export const PshFocusStageStatus = ({
  status,
  axis,
  lifecycle
}: {
  ...
  <Space direction='vertical' size={10} style={{ width: '100%' }}>
    ...
    <MetaFooter
      items={[
        { label: 'HCD', value: <>{PSHFS_HCD_LABEL} <Typography.Text type='secondary' style={{ fontSize: 11 }}>(config)</Typography.Text></> },
