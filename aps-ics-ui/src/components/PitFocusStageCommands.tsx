/*
 * PitFocusStage Commands section (SDD §4.3 "Command Section"). One row per
...
import type { CmdName, PositionMethod, StatusSnapshot } from '../models/pitFocusStage'
...
export const PitFocusStageCommands = ({
  status,
  ready,
  busy,
  run
