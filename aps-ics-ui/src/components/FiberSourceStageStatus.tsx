 ...
 * light state, not a controller-4 readback (RIO not wired this cut).
 *
...
export const FiberSourceStageStatus = ({
  ...
  <Space direction='vertical' size={8} style={{ width: '100%' }}>
    ...
    <AxisBlock title='X axis' axis={xAxis} />
    <AxisBlock title='Y axis' axis={yAxis} />
    <AxisBlock title='Z axis' axis={zAxis} />
