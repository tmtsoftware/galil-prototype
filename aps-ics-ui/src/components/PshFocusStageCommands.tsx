/*
 * PshFocusStage Commands section (SDD §4.3 "Command Section"). One row per
...
import type { CmdName, PositionMethod, StatusSnapshot } from '../models/pshFocusStage'
...
export const PshFocusStageCommands = ({
  status,
  ready,
  busy,
  run
